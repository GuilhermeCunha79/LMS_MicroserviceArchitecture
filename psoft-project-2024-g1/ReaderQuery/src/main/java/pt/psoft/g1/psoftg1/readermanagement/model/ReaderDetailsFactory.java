...
public class ReaderDetailsFactory {
    ...
    public static ReaderDetails create(int readerNumber, Reader reader, String birthDate, String phoneNumber, boolean gdpr, boolean marketing, boolean thirdParty, String photoURI, List<Long> interestList) {
