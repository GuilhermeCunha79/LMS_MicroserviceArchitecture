...
import pt.psoft.g1.psoftg1.shared.model.generateID.GenerateIDService1Impl;
import pt.psoft.g1.psoftg1.shared.model.generateID.GenerateIDService2Impl;
...
public class LendingServiceImpl implements LendingService {
    ...
    public LendingServiceImpl(@Value("${reader.repository.type}") String readerRepositoryType,
                              ...
                              LendingFactory lendingFactory, @Value("${universal.lendingRecommendation.algorithm}") String beanContext,  @Value("${universal.generateID}") String generateId) {
