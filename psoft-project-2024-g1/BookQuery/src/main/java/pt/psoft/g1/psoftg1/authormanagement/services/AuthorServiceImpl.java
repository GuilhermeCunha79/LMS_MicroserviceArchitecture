...
public class AuthorServiceImpl implements AuthorService {
    ...
    public AuthorServiceImpl(
            AuthorRepository authorRepository, BookRepository bookRepositoryType,
            ApplicationContext context, AuthorMapper mapper, PhotoRepository photoRepository, GenerateIDService generateId) {
        this.bookRepository = bookRepositoryType;
        this.mapper = mapper;
        this.photoRepository = photoRepository;
        this.authorRepository = authorRepository;
        this.authorIDService = generateId;
    }
