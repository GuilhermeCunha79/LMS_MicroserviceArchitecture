...
public class Bootstrapper implements CommandLineRunner {
    ...
    private void createAuthors() {
        if (authorRepository.searchByNameName("Manuel Antonio Pina").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Manuel Antonio Pina",
        ...
        if (authorRepository.searchByNameName("Antoine de Saint Exupéry").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Antoine de Saint Exupéry",
        ...
        if (authorRepository.searchByNameName("Alexandre Pereira").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Alexandre Pereira",
        ...
        if (authorRepository.searchByNameName("Filipe Portela").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Filipe Portela",
        ...
        if (authorRepository.searchByNameName("Ricardo Queirós").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Ricardo Queirós",
        ...
        if (authorRepository.searchByNameName("Freida Mcfadden").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Freida Mcfadden",
        ...
        if (authorRepository.searchByNameName("J R R Tolkien").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"J R R Tolkien",
        ...
        if (authorRepository.searchByNameName("Gardner Dozois").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Gardner Dozois",
        ...
        if (authorRepository.searchByNameName("Lisa Tuttle").isEmpty()) {
            final Author author = new Author(String.valueOf(Generator.generateLongID()),"Lisa Tuttle",
